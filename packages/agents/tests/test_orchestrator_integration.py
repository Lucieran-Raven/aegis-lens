...
class TestOrchestratorIntegration:
    ...
    def test_orchestrator_sequential_execution(self, multi_agent_orchestrator):
        ...
        with patch.object(
            ...
            "_call_wasm_module",
            return_value={"jitter_score": 25.5, "jitter_std": 10.2, "jitter_mean": 15.0, "anomaly_count": 2},
        ), patch.object(
            multi_agent_orchestrator.agents["echo"],
            "_call_wasm_module",
            return_value={"delay_score": 25.5, "delay_ms": 12.5, "threshold_crossed": False, "signal_quality": 0.9},
        ):
    ...
    def test_orchestrator_with_all_agents(self, multi_agent_orchestrator):
        ...
        with patch.object(
            ...
            "_call_wasm_module",
            return_value={"liveness_score": 75.5, "trajectory_smoothness": 0.85, "blink_rate": 12, "fixation_count": 8},
        ), patch.object(
            multi_agent_orchestrator.agents["lipsync"],
            "_call_wasm_module",
            return_value={"sync_score": 85.5, "sync_error": 15.2, "phoneme_match_rate": 0.9, "mouth_openness_variance": 25.0},
        ):
            result = multi_agent_orchestrator.execute({
                "timestamps": [0, 100, 200, 300],
                "sample_rate": 44100,
